...
impl IndexHeader {
    /// Construct an `IndexHeader` from `IndexConfig` + embedding dimensions + metadata.
    ...
    /// Validate that this header is compatible with the given `IndexConfig`.
...
mod tests {
    ...
    // -----------------------------------------------------------------------
    // Tests for IndexHeader::validate_against (moved from validation.rs)
    // -----------------------------------------------------------------------
